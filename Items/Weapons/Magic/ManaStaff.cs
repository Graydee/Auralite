...
namespace Auralite.Items.Weapons.Magic
{
    public class ManaStaff : ModItem
    {
        public override void SetDefaults()
        {
            item.name = "Mana Staff";
            item.damage = 21; //The damage
            item.magic = true; //Whether or not it is a magic weapon
            item.width = 54; //Item width
            item.height = 54; //Item height
            item.maxStack = 1; //How many of this item you can stack
            item.toolTip = "Launches a splitting mana bolt"; //The item’s tooltip
            item.useTime = 38; //How long it takes for the item to be used
            item.useAnimation = 38; //How long the animation of the item takes
            ...
            item.shoot = mod.ProjectileType("ManaSplitter");
