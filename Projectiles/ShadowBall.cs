...
namespace Auralite.Projectiles
{
	public class ShadowBall : ModProjectile
    {
        ...
        {
            projectile.name = "Shadow ball"; //Name of the projectile, only shows this if you get killed by it
            projectile.timeLeft = 700; //The amount of time the projectile is alive for
