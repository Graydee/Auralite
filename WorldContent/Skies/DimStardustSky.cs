...
{
	internal class DimStardustSky : CustomSky
	{
		private struct Star
		{
		...
		private DimStardustSky.Star[] _stars;

		private float _fadeOpacity;

		public override void OnLoad()
		{
			this._planetTexture = ModLoader.GetTexture("Terraria/Misc/StarDustSky/Planet");
		...
		public override void Activate(Vector2 position, params object[] args)
		{
			...
			int num = 200;
			int num2 = 10;
			this._stars = new DimStardustSky.Star[num * num2];
			int num3 = 0;
			for (int i = 0; i < num; i++)
			{
			...
			Array.Sort<DimStardustSky.Star>(this._stars, new Comparison<DimStardustSky.Star>(this.SortMethod));
		}

		private int SortMethod(DimStardustSky.Star meteor1, DimStardustSky.Star meteor2)
		{
